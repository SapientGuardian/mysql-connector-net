...
namespace MySQL.Data.Entity
{
	public class MySQLRelationalConnection : RelationalConnection
	{
		...
		protected MySQLRelationalConnection CreateDefaultConnection()
		{
			var connStringBuilder = new MySqlConnectionStringBuilder { ConnectionString = ConnectionString, Database = "" };
